...
redefineClass(JNIEnv *env, jclass clazz, jclass target, jbyteArray dex_bytes) {
    ALOGI("==========redefineClass =======");
...
JvmTINativeMethodBind(jvmtiEnv *jvmti_env, JNIEnv *jni_env, jthread thread, jmethodID method,
    ...
    jmethodID methodid = jni_env->GetStaticMethodID(clazz, "retransformClasses",
                                                    "([Ljava/lang/Class;)V");
    jmethodID methodid2 = jni_env->GetStaticMethodID(clazz, "getObjectSize",
                                                     "(Ljava/lang/Object;)J");
    jmethodID methodid3 = jni_env->GetStaticMethodID(clazz, "redefineClass",
