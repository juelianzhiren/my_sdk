...
/**
 * @Auther: liqiang(这段代码只能计算150年内的农历，超过2049就无法计算了)
 * @Date: 2019/5/27 11:54
 * @Description: 计算农历节假日信息 SimpleCalendar.Element
 *               element=SimpleCalendar.getCalendarDetail("2019-06-06","yyyy-MM-dd");
 *               element=SimpleCalendar.getCalendarDetail("2019-06-04","yyyy-MM-dd");
 */
public class SimpleCalendar {
	long[] lunarInfo = new long[] { 0x4bd8, 0x4ae0, 0xa570, 0x54d5, 0xd260, 0xd950, 0x5554, 0x56af, 0x9ad0, 0x55d2,
			0x4ae0, 0xa5b6, 0xa4d0, 0xd250, 0xd255, 0xb54f, 0xd6a0, 0xada2, 0x95b0, 0x4977, 0x497f, 0xa4b0, 0xb4b5,
	...
	String[] solarTerm = new String[] { "小寒", "大寒", "立春", "雨水", "惊蛰", "春分", "清明", "谷雨", "立夏", "小满", "芒种", "夏至", "小暑",
			"大暑", "立秋", "处暑", "白露", "秋分", "寒露", "霜降", "立冬", "小雪", "大雪", "冬至" };
	int[] sTermInfo = new int[] { 0, 21208, 42467, 63836, 85337, 107014, 128867, 150921, 173149, 195551, 218072, 240693,
	...
	static String[] dayChinese = new String[] { "一", "二", "三", "四", "五", "六", "七", "八", "九", "十", "十一", "十二", "十三",
	...
	public static void main(String[] args) throws ParseException {
		Element element=SimpleCalendar.getCalendarDetail("1790-04-16","yyyy-MM-dd");
		String str = "";
		str += element.lYear + "-";
		str += element.lMonth + "-";
		str += element.lDay;
	...
	public void calendar(int y, int m) throws ParseException {
		...
		Boolean lL = null;
		Long lD2 = null;
		Integer lY = null, lM = null, lD = 1, lX = 0, tmp1, tmp2, lM2, lY2 = null, tmp3, dayglus, bsg, xs, xs1, fs, fs1,
				cs, cs1 = null;
		...
		for (int i = 0; i < this.length; i++) {
			...
			lD2 = (dayCyclical + i);
			Element element = new Element(y, m + 1, i + 1, (nStr1[(i + this.firstWeek) % 7]), lY, lM, lD++, lL, cY, cM,
					cD);
			...
			element.setSgz5(CalConv2(paramterLy2, paramterLm2, (int) paramterLd2, paramterLy2b, paramterLy2c, lM,
					paramterLld, m + 1, cs1 == null ? -1 : cs1));
		...
		if (m == 2 || m == 3) {
			...
			if (m == estDay.m)
				elements.get(estDay.d - 1).solarFestival = elements.get(estDay.d - 1).solarFestival
						+ " 复活节(Easter Sunday)";
		}
	...
	public String CalConv2(int yy, int mm, int dd, int y, int d, int m, int dt, int nm, int nd) {
		int dy = d + dd;
		if ((yy == 0 && dd == 6) || (yy == 6 && dd == 0) || (yy == 1 && dd == 7) || (yy == 7 && dd == 1)
				|| (yy == 2 && dd == 8) || (yy == 8 && dd == 2) || (yy == 3 && dd == 9) || (yy == 9 && dd == 3)
				|| (yy == 4 && dd == 10) || (yy == 10 && dd == 4) || (yy == 5 && dd == 11) || (yy == 11 && dd == 5)) {
		...
		} else if ((y == 0 && dy == 911) || (y == 1 && dy == 55) || (y == 2 && dy == 111) || (y == 3 && dy == 75)
				|| (y == 4 && dy == 311) || (y == 5 && dy == 9) || (y == 6 && dy == 511) || (y == 7 && dy == 15)
	...
	public static class Element {
		...
		public Element(int sYear, int sMonth, int sDay, char week, int lYear, int lMonth, int lDay, boolean isLeap,
				String cYear, String cMonth, String cDay) {
