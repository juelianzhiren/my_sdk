...
public class FlowLayout extends ViewGroup {
    private static final String TAG = "noahedu.FlowLayout";
    //存放容器中所有的View
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            Log.v(TAG, "totalHeight = " + totalHeight + "; perLineMaxHeight = " + perLineMaxHeight + "; i = " + i + "; totalLineWidth = " + totalLineWidth + "; childWidth = " + childWidth + "; widthSize = " + widthSize);
        }
