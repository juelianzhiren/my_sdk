...
import com.ztq.sdk.activity.PieImageActivity;
...
public class PieImageView extends View {
    private static final String TAG = "noahedu." + PieImageActivity.class.getSimpleName();
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (MeasureSpec.AT_MOST == widthMode || MeasureSpec.AT_MOST == heightMode) {
            ...
            Log.v(TAG, "size = " + size + "; measuredWidth = " + measuredWidth + "; measuredHeight = " + measuredHeight);
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        Log.v(TAG, "min = " + min + "; max = " + max + "; r = " + r + "; w = " + w + "; h = " + h);
