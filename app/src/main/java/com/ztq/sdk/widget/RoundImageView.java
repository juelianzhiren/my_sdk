...
public class RoundImageView extends ImageView {
    private static final String TAG = "noahedu.RoundImageView";
    //圆角大小，默认为10
    ...
    private Bitmap drawableToBitamp(Drawable drawable) {
        ...
        Log.v(TAG, "intrinsicWidth = " + drawable.getIntrinsicWidth() + "; IntrinsicHeight = " + drawable.getIntrinsicHeight() + "; width = " + getWidth() + "; height = " + getHeight());
