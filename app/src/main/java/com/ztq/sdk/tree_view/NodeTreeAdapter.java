...
public class NodeTreeAdapter extends BaseAdapter {
    private static final String TAG = "noahedu.NodeTreeAdapter";
    ...
    public NodeTreeAdapter(Context context, android.widget.ListView listView, LinkedList<Node> linkedList) {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, android.view.View view, int position, long id) {
                android.util.Log.v(TAG, "onItemClick, position = " + position);
    ...
    private void expandOrCollapse(int position) {
        ...
        if (node != null && !node.isLeaf()) {
            ...
            if (old) {
                java.util.List<Node> nodeList = node.get_childrenList();
    ...
    private void collapse(Node node, int position) {
        ...
        java.util.List<Node> nodes = node.get_childrenList();
        int size = nodes.size();
        Node tmp = null;
        for (int i = 0; i < size; i++) {
            tmp = nodes.get(i);
    ...
    public android.view.View getView(int position, android.view.View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            holder.label = (android.widget.TextView) convertView.findViewById(R.id.id_treenode_label);
        ...
        holder.confirm.setOnClickListener(new android.view.View.OnClickListener() {
            @Override
