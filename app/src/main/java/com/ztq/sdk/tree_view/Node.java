...
public abstract class Node<T> {
    ...
    private java.util.List<Node> _childrenList = new ArrayList<>();//所有的孩子节点
    ...
    public java.util.List<Node> get_childrenList() {
        return _childrenList;
    }

    public void set_childrenList(java.util.List<Node> _childrenList) {
