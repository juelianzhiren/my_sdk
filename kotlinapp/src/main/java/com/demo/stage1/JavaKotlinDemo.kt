...
fun main() {
    ...
    println(JavaKotlinDemo().info1.length)
    // println(KtBase129().info2.length) // 引发空指针异常

    // 下面是 Java 与 KT 交互 ，错误的案例
    // : String! Java 与 KT 交互的时候，Java给KT用的值，都是 : String! 这种类型
    val info1  = JavaKotlinDemo().info1
    val info2 = JavaKotlinDemo().info2
    ...
    val info1s  = JavaKotlinDemo().info1
    val info2s = JavaKotlinDemo().info2
    ...
    val info1ss : String?  = JavaKotlinDemo().info1
    val info2ss : String? = JavaKotlinDemo().info2
