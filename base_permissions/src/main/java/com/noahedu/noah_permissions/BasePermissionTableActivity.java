...
public abstract class BasePermissionTableActivity extends TabActivity implements DialogInterface.OnClickListener, EasyPermissions.PermissionCallbacks, EasyPermissions.RationaleCallbacks {

    private static final String TAG = BasePermissionTableActivity.class.getSimpleName();
...
//        RuntimeException eDebug = new RuntimeException("leo's debug");
//        eDebug.fillInStackTrace();
//        Log.i(TAG, "Stack Trace:", eDebug);
...
//        permissionsGranted();
    ...
    public void onPermissionsDenied(int requestCode, @NonNull List<String> perms) {
        ...
        if (EasyPermissions.somePermissionPermanentlyDenied(this, perms)) {
            ...
            if (mDialog == null) {
                mDialog = PermissionsUtil.createDialog(this, null, this);
            }
