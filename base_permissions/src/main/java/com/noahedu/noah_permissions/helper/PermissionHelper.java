...
public abstract class PermissionHelper<T> {
    ...
    public static PermissionHelper<android.app.Fragment> newInstance(android.app.Fragment host) {
        ...
        return new FragmentPermissionHelper(host);
    }
    ...
    public void requestPermissions(@NonNull String rationale,
        ...
        this.requestPermissions(rationale, positiveButton, negativeButton, theme, requestCode, perms, null);
    }
    ...
    public void requestPermissions(@NonNull String rationale,
        ...
        if (shouldShowRationale(perms)) {
            showRequestPermissionRationale(
                    rationale, positiveButton, negativeButton, theme, requestCode, perms, rationaleCallbacks);
        } else {
