...
public abstract class BasePermissionNormalActivity extends Activity implements DialogInterface.OnClickListener, EasyPermissions.PermissionCallbacks, EasyPermissions.RationaleCallbacks {

    private static final String TAG = BasePermissionNormalActivity.class.getSimpleName();
