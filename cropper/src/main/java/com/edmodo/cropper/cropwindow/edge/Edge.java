...
public enum Edge {
    ...
    public void adjustCoordinate(float x, float y,  RectF imageRect, float imageSnapRadius, float aspectRatio) {
        ...
        switch (this) {
            case LEFT:
                mCoordinate = adjustLeft(imageRect.left, imageRect, imageSnapRadius, aspectRatio);
                break;
            case TOP:
                mCoordinate = adjustTop(y, imageRect, imageSnapRadius, aspectRatio);
                break;
            case RIGHT:
                mCoordinate = adjustRight(imageRect.right, imageRect, imageSnapRadius, aspectRatio);
                break;
            case BOTTOM:
